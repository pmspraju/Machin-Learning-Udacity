...
class Simulator(object):
        ...
        if self.log_metrics:
            ...
            if a.learning:
                if self.optimized: # Whether the user is optimizing the parameters and decay functions
                    ...
                    self.log_filename = r"C:\Users\c830587\Installed\Assignments\6 - Reinforcement learning\Project\smartcab\logs\sim_improved-learning.csv"
                    #self.table_filename = os.path.join("logs","sim_improved-learning.txt")
                    self.table_filename = r"C:\Users\c830587\Installed\Assignments\6 - Reinforcement learning\Project\smartcab\logs\sim_improved-learning.txt"
                else: 
                    #self.log_filename = os.path.join("logs", "sim_default-learning.csv")
                    self.log_filename = r"C:\Users\c830587\Installed\Assignments\6 - Reinforcement learning\Project\smartcab\logs\sim_default-learning.csv"
                    #self.table_filename = os.path.join("logs","sim_default-learning.txt")
                    self.table_filename = r"C:\Users\c830587\Installed\Assignments\6 - Reinforcement learning\Project\smartcab\logs\sim_default-learning.txt"
                    
                self.table_file = open(self.table_filename, 'wb')
            else:
                #self.log_filename = os.path.join("logs", "sim_no-learning.csv")
                self.log_filename = r"C:\Users\c830587\Installed\Assignments\6 - Reinforcement learning\Project\smartcab\logs\sim_no-learning.csv"            
    ...
    def run(self, tolerance=0.05, n_test=0):
        ...
        while True:
            ...
            # Flip testing switch
            if not testing:
                if total_trials > 25: # Must complete minimum 20 training trials
                    if a.learning:
